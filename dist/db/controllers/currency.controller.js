...
var CurrencyController = function () { return ({
    getRateByPair: function (_a, res) {
        var params = _a.params;
        return __awaiter(this, void 0, void 0, function () {
            var pairOne_1, pairTwo_1, rateToday, ratePairOne, ratePairTwo, rate, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        pairOne_1 = params.pairOne, pairTwo_1 = params.pairTwo;
                    ...
                    case 1:
                        rateToday = _b.sent();
                        ratePairOne = rateToday.rates.filter(function (item) { return item.ticket === pairOne_1; });
                        ratePairTwo = rateToday.rates.filter(function (item) { return item.ticket === pairTwo_1; });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        currentDate = (0, services_1.getCurrentDate)();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, services_1.fetchLatest)()];
                    case 1:
                        fetchData_1 = _a.sent();
                        rates_1 = [];
                        Object.keys(fetchData_1.rates).forEach(function (key) {
                            rates_1.push({ ticket: key, cost: fetchData_1.rates[key] });
                        });
