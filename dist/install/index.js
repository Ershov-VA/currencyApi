...
var install = function () { return __awaiter(void 0, void 0, void 0, function () {
    var checkUser, admin, rates;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('Проверка на первоначальный запуск');
                return [4 /*yield*/, func_1.installFuncs.isUserPresent()];
            case 1:
                checkUser = _a.sent();
                if (checkUser)
                    return [2 /*return*/, true];
                console.log('Установка пользователя admin - admin');
                return [4 /*yield*/, func_1.installFuncs.createAdmin()];
            case 2:
                admin = _a.sent();
                console.log("\u041D\u0430\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u0435 \u043F\u0435\u0440\u0432\u043E\u043D\u0430\u0447\u0430\u043B\u044C\u043D\u044B\u043C\u0438 \u0434\u0430\u043D\u043D\u044B\u043C\u0438 \u0437\u0430 ".concat(config_1.HISTORY_OFFSET, " \u0434\u043D."));
                return [4 /*yield*/, func_1.installFuncs.getHistoricalRates()];
            case 3:
                rates = _a.sent();
                func_1.installFuncs.postRatesToDB(rates);
